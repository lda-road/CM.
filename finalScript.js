...
if (listenBtn) {
  listenBtn.addEventListener('click', e => {
    e.preventDefault();
    const trackBtn = document.querySelector('[data-tab="tracks"]') ||
                     document.querySelector('[data-tab="tracklist"]');
    if (trackBtn) trackBtn.click();
    const target = document.getElementById('tabsSection') ||
